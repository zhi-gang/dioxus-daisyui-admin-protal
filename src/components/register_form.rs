...
pub fn RegisterForm(cx: Scope) -> Element {
    ...
    cx.render(rsx!{
        div{class:"py-24 px10",
            h2{class:"text-2xl font-semibold mb-2 text-center","Register"}
            form{class:"ml-6 mr-6",
                ...
                div{class:"mb-4",
                    ...
                    div{class:"form-control w-full mt-4",
                        label{class:"label",
                            span{class:"label-text text-base-content undefined","Password (again)"}
                        }
                    }
                    input{class:"input  input-bordered w-full ",r#type:"password",name:"password2"}
                }
                div{class:"text-right text-primary",
                    ...
                    button{r#type:"submit", class:"btn mt-2 w-full btn-primary","Register"}
                }
