        ...
        div{class:"drawer lg:drawer-open",
            ...
            div{class:"drawer-side z-30",
                ...
                ul{class:"menu pt-2  w-80 min-h-full bg-base-100 text-base-content",
                    ...
                    MenuItem {item_type: MenuItemType::Leads, item_name: "Leads" ,url: "/home/leads", d:"M9 3.75H6.912a2.25 2.25 0 00-2.15 1.588L2.35 13.177a2.25 2.25 0 00-.1.661V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18v-4.162c0-.224-.034-.447-.1-.661L19.24 5.338a2.25 2.25 0 00-2.15-1.588H15M2.25 13.5h3.86a2.25 2.25 0 012.012 1.244l.256.512a2.25 2.25 0 002.013 1.244h3.218a2.25 2.25 0 002.013-1.244l.256-.512a2.25 2.25 0 012.013-1.244h3.859M12 3v8.25m0 0l-3-3m3 3l3-3"}
                    MenuItem {item_type: MenuItemType::Transactions, item_name: "Transactions" ,url: "/home/transactions", d:"M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z"}
                    DropdownMenuItem {}
                }
            }    
        }
